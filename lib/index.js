...
class State {
    ...
    update(next) {
        this.curr = Object.assign(Object.assign({}, this.curr), next);
        return this.curr;
    }
}
...
class Clothing {
    constructor(config) {
        ...
        this.config = {
            ...
            size: (_b = config.size) !== null && _b !== void 0 ? _b : 'xs'
        };
    }
}
// Readonly<T> //
...
const paddingNowHasAutoCompleteValues = 'large';
const paddingAlsoAllowsAnyStringValue = '8px';
// Project References //
